...
| EZ-OUT-2 | A command that refuses writes nothing: every file it would otherwise write or remove is left as it found it. | Proved | pending | init/LAWS.bend init_refusal_writes_nothing; lock/LAWS.bend lock_refusal_writes_nothing; remove/LAWS.bend remove_refusal_writes_nothing; add/LAWS.bend add_refusal_writes_nothing; fetch/LAWS.bend fetch_refusal_writes_nothing |
