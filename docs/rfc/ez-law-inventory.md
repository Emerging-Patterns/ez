...
The RFC's "Decided behavior changes" picks five of these to fix, in this order, and a sixth was found on the way. Each fix is a pure decision with quantified laws in `ez/LAWS.bend`; none is a requirement.
