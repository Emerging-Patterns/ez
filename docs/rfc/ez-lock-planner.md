...
**Update:** WP6's first half has landed: EZ-RES-4 and EZ-RES-6 are proved (the laws section below says where the laws differ from the sketches). EZ-RES-5 and EZ-RES-8 are its second half.
